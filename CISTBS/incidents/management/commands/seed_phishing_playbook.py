...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        playbook = Playbook.objects.create(
            ...
            description="A comprehensive guide on investigating, remediating, communicating, and recovering from phishing incidents.",
            created_by = reporter,
            content = """
                ## Playbook: Phishing
...
1. <a name="phishing-playbook-ref-4"></a>[Anti-Phishing best practices](https://resources.infosecinstitute.com/category/enterprise/phishing/phishing-countermeasures/anti-phishing-best-practices/#gref)
        ...
        self.stdout.write(self.style.SUCCESS('Successfully loaded the phishing playbook into the database.'))
